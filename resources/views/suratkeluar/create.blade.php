...
@section('content')
    ...
    <div class="container">
        <h1><p style="text-align:center">Tambah Data Surat Keluar</p></h1>
        <form action="/suratkeluar/store" method="POST">
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Tanggal Surat</label>
                <input type="text" name="tanggal_surat" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="tujuan_penerima" rows="5"></textarea><br>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="no_sertifikat_bln_keps" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            @csrf
